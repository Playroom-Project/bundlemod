...
/**
 * This item keeps native Small Ships brigg item behavior at the item level while
 ...
 */
public final class VariantBriggCompatItem extends BriggItem {
    private final String woodTypeId;

    public VariantBriggCompatItem(String woodTypeId, Properties properties) {
    ...
    public @NotNull Component getName(@NotNull ItemStack stack) {
        ...
        if (wood == null) {
            return Component.literal(woodTypeId + " Brigg");
        }

        return Component.literal(wood.englishDisplayName() + " Brigg");
    }

    /**
     * This creates the brigg entity and writes the compat wood id before the entity
     * is spawned into the world.
     */
    private @NotNull Boat createCompatShip(@NotNull Level level, @NotNull HitResult hitResult) {
        BriggEntity entity = BriggEntity.summon(
                level,
