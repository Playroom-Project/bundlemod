...
/**
 * This item keeps native Small Ships drakkar item behavior at the item level while
 ...
 */
public final class VariantDrakkarCompatItem extends DrakkarItem {
    private final String woodTypeId;

    public VariantDrakkarCompatItem(String woodTypeId, Properties properties) {
    ...
    public @NotNull Component getName(@NotNull ItemStack stack) {
        ...
        if (wood == null) {
            return Component.literal(woodTypeId + " Drakkar");
        }

        return Component.literal(wood.englishDisplayName() + " Drakkar");
    }

    /**
     * This creates the drakkar entity and writes the compat wood id before the entity
     * is spawned into the world.
     */
    private @NotNull Boat createCompatShip(@NotNull Level level, @NotNull HitResult hitResult) {
        DrakkarEntity entity = DrakkarEntity.summon(
                level,
