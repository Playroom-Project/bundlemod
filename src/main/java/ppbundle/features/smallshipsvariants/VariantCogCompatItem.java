...
/**
 * This item keeps native Small Ships cog item behavior at the item level while
 ...
 */
public final class VariantCogCompatItem extends CogItem {
    private final String woodTypeId;

    public VariantCogCompatItem(String woodTypeId, Properties properties) {
    ...
    public @NotNull Component getName(@NotNull ItemStack stack) {
        ...
        if (wood == null) {
            return Component.literal(woodTypeId + " Cog");
        }

        return Component.literal(wood.englishDisplayName() + " Cog");
    }

    /**
     * This creates the cog entity and writes the compat wood id before the entity
     * is spawned into the world.
     */
    private @NotNull Boat createCompatShip(@NotNull Level level, @NotNull HitResult hitResult) {
        CogEntity entity = CogEntity.summon(
                level,
